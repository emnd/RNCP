...
public class FilmDetailJson {
   ...
   // private Production_companies[] production_companies;
    ...
    public GenresJson[] getGenres ()
    {
        return genres;
    }

    public void setGenres (GenresJson[] genres)
    {
        this.genres = genres;
    }
